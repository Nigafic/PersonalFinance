...
//        System.out.println(Arrays.toString(Text.getMonths()));
    ...
    private static void testModel() throws ModelException {
        ...
        transactions.add(new Transaction(ac2, article3, 30000.00));
        transactions.add(new Transaction(ac2, article1, (double) -1500, "На выходные"));
        transactions.add(new Transaction(ac1, article2, (double) -5500, "Основная квартира"));
        transactions.add(new Transaction(ac3, article5, (double) 1000));
        transactions.add(new Transaction(ac1, article2, (double) -4000, "Вторая квартира"));
        transactions.add(new Transaction(ac2, article3, (double) 25000, new Date((new Date()).getTime() - (long) 86400000 * 30)));
        transactions.add(new Transaction(ac3, article5, (double) 1000, new Date((new Date()).getTime() - (long) 86400000 * 30)));
